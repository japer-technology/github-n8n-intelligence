...
| Skills | `.pi/skills/` | On-demand capability packages (`memory`, `n8n-workflow-builder`, `n8n-executor`) |
...
These are required for n8n workflow execution on GitHub Actions:

| Dependency | Description |
|------------|-------------|
| [n8n](https://www.npmjs.com/package/n8n) | Workflow automation platform. Installed globally via `npm install -g n8n` at workflow runtime. |
| [Node.js 22.x](https://nodejs.org/) | Runtime for n8n execution engine. |
